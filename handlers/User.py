...
async def config(ev,bot,jdb,message_edited=None):
    ...
    buttons = []
    buttons.append([Button.inline(' << Home ','user_start')])
...
async def start(ev,bot,jdb,message_edited=None):
    text = 'MoodleBot Down/Up Activo!\n\n'
    text+= 'Administrador: @User0075_69\n\n'
    text+= 'Versión 6.0.5'

    buttons = [
        [Button.inline('🗂Abrir Directorio','open_root')],
        [Button.inline('⚙️Ajustes de la cuenta⚙️','user_config')]
    ]
